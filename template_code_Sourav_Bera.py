...
if __name__ == "__main__":
    ...
    sentence1, sentence2 = sys.argv[1][0:sys.argv[1].index(",")], sys.argv[1][sys.argv[1].index(",")+1:]
    ...
    pool_vectors = torch.max(output.last_hidden_state, dim=1)[0]      # Fill up this '----------' section
    # cls_vectors (2x768) is the vector generated by taking the CLS token
    #cls_vectors = --------------       # Fill up this '----------' section
    cls_vectors = output.last_hidden_state[:, 0, :]       # Fill up this '----------' section
